...
function render() {
  ...
  else if (route === 'contact') app.innerHTML = page('Contact', 'Book a consultation with UpSkillPro.', 'Tell us about your workforce challenge and we will help shape the right ESP English and soft skills training plan.', `<div class="contact-panel"><a href="mailto:hello@upskillpro.co.uk">hello@upskillpro.co.uk</a><a href="tel:+440000000000">+44 0000 000000</a><a class="primary-button" href="#workforce-training-request" data-route="workforce-training-request">Request Training Plan</a></div>`);
